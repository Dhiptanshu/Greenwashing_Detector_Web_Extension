...
buzzwords = [
    # Common green claims
    "green", "eco", "eco-friendly", "environmentally friendly", "carbon neutral", 
    "net-zero", "climate neutral", "sustainable", "renewable", "clean energy", 
    "low carbon", "zero emissions", "planet", "earth-friendly", "non-toxic", 
    "biodegradable", "compostable", "ethical", "organic", "natural", 
    "bio", "recyclable", "recycled", "less plastic", "plastic-free",

    # Vague/aspirational phrases
    "responsible", "doing our part", "future-friendly", "green mission", 
    "committed to sustainability", "conscious choice", "nature-inspired", 
    "eco-conscious", "mindful", "planet-positive", "eco innovation", 
    "climate positive", "sustainably sourced", "eco-certification", 
    "eco packaging", "low impact", "clean production", "green certified", 

    # Corporate jargon often used to obscure actual impact
    "offset", "carbon offset", "carbon credits", "green energy credits", 
    "net impact", "environmental promise", "long-term goal", "strategy 2030",
    "ESG goals", "sustainability roadmap", "eco strategy", "green pledge"
]
...
def analyze_text(raw_text):
    ...
    for sentence in sentences:
        ...
        if label == "LABEL_1":
            tag = f"✅ Environmental Claim ({score:.1f}%)"
            ...
            tag = "🤔 Not an Environmental Claim"
